<template>
  <div class='index' style="padding: 10px;">
    ...
    <Row class="addHeader">
      ...
      <Col span="22"><p>{{$t('roles.editRoles')}}</p></Col>
    </Row>
    ...
    <Row class="formBox">
      ...
      <Form ref="formValidate" :model="formValidate" :rules="ruleValidate" :label-width="labelWidth">
        <Row>
          ...
          <FormItem :label="$t('roles.rolesId')+fuhao" prop="role_id">
            <Input v-model="formValidate.role_id"  :disabled="disabledId" :maxlength="20"></Input>
          </FormItem>
          </Col>
        ...
        <Row>
          <Col span="10" offset="4">
          <FormItem :label="$t('roles.rolesName')+fuhao" prop="role_name">
            <Input v-model="formValidate.role_name" :maxlength="20"></Input>
          </FormItem>
          </Col>
        ...
        <Row>
          <Col span="10" offset="4">
          <FormItem :label="$t('roles.rolesType')+fuhao" prop="role_attr">
            <Select v-model="formValidate.role_attr" @on-change="getAttr">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" >
              <tr v-for="(val,key) in modalApp" class="tableBodyInfo">
                <td width="20%">
                  <Row>
                    <Col>
                    <p class="table_text_center"><b>{{val.app_name}}</b><br>
                      <Checkbox
                        :value="val.isCheckedAll"
                        @on-change="checkAll_app(key)">
                        <span class="checkbox_quanxuan">{{$t('share.all')}}</span>
                      </Checkbox>
                    </p>
                    </Col>
                  </Row>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" >
              <tr v-for="(val,key) in modalPc" class="tableBodyInfo">
                <td width="20%">
                  <Row>
                    <Col>
                    <p class="table_text_center"><b>{{val.pc_name}}</b><br>
                      <Checkbox
                        :value="val.isCheckedAll"
...
<script src="../js/roleEdit.js">

</script>
<style >
  @import "../css/roleEdit.css";
</style>
<style scoped>
